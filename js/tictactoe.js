...
let activePlayer = "X";
// This array stores an array of movies . WE use this to determine win conditions
let selectedSquares = [];

//This function is for placing an x or o in a square.
function placeXOrO(squareNumber) {
    //This conditions ensures a square hasn't been selected already.
    // Ther .some() method is used to check each element of the selectSquare array
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === "X") {
            ...
            // If activePlayer is equal to "O", the o.png is placerd in HTML
...
function drawWinLine (coordX1, coordY1, coordX2, coordY2) {
    ...
    //This line indicates where the start of a lines y axis is
        ...
        x = x1,
        //This variable stores temporary y axix we update in our animation loop
        y = y1;
...
function resetGame() {
    ...
    //This reset our array so it empty and we can start over
    selectedSquares = [];
}
